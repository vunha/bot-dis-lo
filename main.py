...
players_file = "players.json"  # Tên tệp tin để lưu trữ dữ liệu người chơi
# Địa chỉ IP và cổng của máy chủ FiveM
server_ip = '103.249.70.30'
server_port = '30120'
def is_allowed_channel():
    async def predicate(ctx):
        allowed_channel_ids = [951526583934541875,965872043679698954,1001075873866326036, 993713667990368336 , 1050032619854778439, 993520590365397042]  # Thêm các ID kênh vào danh sách này
